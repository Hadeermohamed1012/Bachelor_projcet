...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="9d618d08-4f87-4861-bfd5-7fbefdfdcb2e" name="Default Changelist" comment="" />
    ...
    <session id="507044391">
      <usages-collector id="statistics.lifecycle.project">
        <counts>
          ...
          <entry key="project.open.time.47" value="2" />
      ...
      <usages-collector id="statistics.file.extensions.edit">
        <counts>
          <entry key="java" value="1311" />
          <entry key="txt" value="108" />
